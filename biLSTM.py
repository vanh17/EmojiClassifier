...
class BILSTM:
    ...
    def train(self, train_texts: Sequence[Text], train_labels: Sequence[Text]):
        ...
        # self.model.add(Bidirectional(GRU(self.lstm_out, activation='tanh', recurrent_activation='hard_sigmoid', dropout_U=0.1, dropout_W=0.1, return_sequences=True), merge_mode='sum'))
        ...
        # #save the best model
        filepath="models/best_biLSTM.hd5"
    ...
    def predict(self, test_texts: Sequence[Text]):
        self.model = load_model("models/best_biLSTM.hd5")
