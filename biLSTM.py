...
class BILSTM:
    ...
    def train(self, train_texts: Sequence[Text], train_labels: Sequence[Text]):
        ...
        model.add(Bidirectional(LSTM(self.lstm_out, dropout_U=0.1, dropout_W=0.1, return_sequences=True)))
        model.add(Bidirectional(LSTM(self.lstm_out, dropout_U=0.1, dropout_W=0.1))
