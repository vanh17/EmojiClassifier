...
def test_prediction(capsys, min_f1=0.16):
    ...
    devel_examples = classify.read_tweet("dataset/us_dev.text", "dataset/us_dev.labels")
...
def test_very_accurate_prediction():
    test_prediction(capsys=None, min_f1=0.27)
